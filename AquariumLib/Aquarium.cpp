...
void Aquarium::OnDraw(wxDC *dc)
{
    ...
    // Draw text with custom font and colour
...
{
    /// Initial fish X coordinate
    const int InitialX = 200;
    /// Initial fish Y coordinate
...
/**
 * Removes, and then re-appends item to this aquarium's list of items
 *
 * @param item item to be reset
 */
void Aquarium::ReAdd(std::shared_ptr<Item> item)
{
...
void Aquarium::XmlItem(wxXmlNode *node)
{
    ...
    {
        item = make_shared<FishSparty>(this);
    }
